...
ALTER TABLE cds_cdm.episode  ADD CONSTRAINT xpk_episode PRIMARY KEY (episode_id);
ALTER TABLE cds_cdm.metadata  ADD CONSTRAINT xpk_metadata PRIMARY KEY (metadata_id);
